...
public class Principal {
    ...
    public static void verificarJugador() {
        Scanner entrada = new Scanner(System.in);
        System.out.println("Ingrese nombre del jugador que quiere  buscar:");
        String nombre = entrada.nextLine();
        ...
        Jugador n = lectura.obtenerNombreJ(nombre);
        if (n != null) {
            System.out.println("El jugador ingresado se encuentra");
        } else {
            System.out.println("El jugador ingresado no se encuentra");
        }
        lectura.cerrarArchivo();
    }
